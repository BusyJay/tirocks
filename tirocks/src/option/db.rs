...
impl RawDbOptions {
    ...
    simple_access! {
        ...
        rate_limiter / ratelimiter / : &RateLimiter [ .get_ptr() ]
        ...
        info_log: &SysInfoLogger [ .get_ptr() ]
    ...
    simple_access! {
        ...
        /// DBs.
        (add) event_listener / eventlistener/ : &SysEventListener [ .get_ptr() ]
...
impl DbOptions {
    ...
    #[inline]
    pub(crate) fn get_ptr(&self) -> *mut rocksdb_DBOptions {
