...
extern const char* const crocksdb_property_name_num_files_at_level_prefix;
extern const char* const crocksdb_property_name_compression_ratio_at_level_prefix;
extern const char* const crocksdb_property_name_stats;
extern const char* const crocksdb_property_name_ss_tables;
extern const char* const crocksdb_property_name_cf_stats;
extern const char* const crocksdb_property_name_cf_stats_no_file_histogram;
extern const char* const crocksdb_property_name_cf_file_histogram;
extern const char* const crocksdb_property_name_db_stats;
extern const char* const crocksdb_property_name_level_stats;
extern const char* const crocksdb_property_name_num_immutable_mem_table;
extern const char* const crocksdb_property_name_num_immutable_mem_table_flushed;
extern const char* const crocksdb_property_name_mem_table_flush_pending;
extern const char* const crocksdb_property_name_num_running_flushes;
extern const char* const crocksdb_property_name_compaction_pending;
extern const char* const crocksdb_property_name_num_running_compactions;
extern const char* const crocksdb_property_name_background_errors;
extern const char* const crocksdb_property_name_cur_size_active_mem_table;
extern const char* const crocksdb_property_name_cur_size_all_mem_tables;
extern const char* const crocksdb_property_name_size_all_mem_tables;
extern const char* const crocksdb_property_name_num_entries_active_mem_table;
extern const char* const crocksdb_property_name_num_entries_imm_mem_tables;
extern const char* const crocksdb_property_name_num_deletes_active_mem_table;
extern const char* const crocksdb_property_name_num_deletes_imm_mem_tables;
extern const char* const crocksdb_property_name_estimate_num_keys;
extern const char* const crocksdb_property_name_estimate_table_readers_mem;
extern const char* const crocksdb_property_name_is_file_deletions_enabled;
extern const char* const crocksdb_property_name_num_snapshots;
extern const char* const crocksdb_property_name_oldest_snapshot_time;
extern const char* const crocksdb_property_name_oldest_snapshot_sequence;
extern const char* const crocksdb_property_name_num_live_versions;
extern const char* const crocksdb_property_name_current_super_version_number;
extern const char* const crocksdb_property_name_estimate_live_data_size;
extern const char* const crocksdb_property_name_min_log_number_to_keep;
extern const char* const crocksdb_property_name_min_obsolete_sst_number_to_keep;
extern const char* const crocksdb_property_name_total_sst_files_size;
extern const char* const crocksdb_property_name_live_sst_files_size;
extern const char* const crocksdb_property_name_base_level;
extern const char* const crocksdb_property_name_estimate_pending_compaction_bytes;
extern const char* const crocksdb_property_name_aggregated_table_properties;
extern const char* const crocksdb_property_name_aggregated_table_properties_at_level;
extern const char* const crocksdb_property_name_actual_delayed_write_rate;
extern const char* const crocksdb_property_name_is_write_stopped;
extern const char* const crocksdb_property_name_is_write_stalled;
extern const char* const crocksdb_property_name_estimate_oldest_key_time;
extern const char* const crocksdb_property_name_block_cache_capacity;
extern const char* const crocksdb_property_name_block_cache_usage;
extern const char* const crocksdb_property_name_block_cache_pinned_usage;
extern const char* const crocksdb_property_name_options_statistics;
